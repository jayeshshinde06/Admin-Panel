  ...
  <div className="auth-right py-32 px-24 d-flex flex-column justify-content-center">
    <div className="max-w-464-px mx-auto w-100">
      <div>
        ...
        <h4 className="mb-12 mt--45">Sign In to your Account</h4>
      ...
      <form action="#">
        ...
        <div className="position-relative mb-20">
          <div className="icon-field">
            ...
            <input type="password" className="form-control h-56-px bg-neutral-50 radius-20  " id="your-password" placeholder="Password" />
          </div>
